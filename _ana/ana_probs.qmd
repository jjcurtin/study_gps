...
probs <- read_csv(here::here(path_input, str_c("local_preds_failed_", params$version, ".csv")))

probs <- read_csv(here::here(path_input, str_c("local_preds_success_", params$version, ".csv")))

...
Candidate feature engineering changes:
 - Combine high/medium and low/no risk
 - Drop emotion == mixed
 - Drop type == other
 - Target encoding for type -- comparison between all categorical variables by target or one hot encoding that are not binary

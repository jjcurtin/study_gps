...
```{r}
library(tidyverse)
library(tidymodels, exclude = "scales")
...
strat_none |> 
  ...
  geom_vline(aes(xintercept = median(strat_none_best$median_roc_auc)), color = "red") +
  xlim(0.5,1.0)
```
...
strat_yn |> 
  ...
  ggplot() +
  geom_histogram(aes(x = roc_auc), bins = 15, color = "black", fill = "light grey")  +
  geom_vline(aes(xintercept = median(strat_yn_best$median_roc_auc)), color = "red") +
  xlim(0.5,1.0)
```
...
strat_lh |> 
  ...
  ggplot() +
  geom_histogram(aes(x = roc_auc), bins = 15, color = "black", fill = "light grey")  +
  geom_vline(aes(xintercept = median(strat_lh_best$median_roc_auc)), color = "red") +
  xlim(0.5,1.0)
```
...
strat_nlh |> 
  ...
  ggplot() +
  geom_histogram(aes(x = roc_auc), bins = 15, color = "black", fill = "light grey")  +
  geom_vline(aes(xintercept = median(strat_nlh_best$median_roc_auc)), color = "red") +
  xlim(0.5,1.0)
```

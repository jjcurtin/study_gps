...
path_output <- format_path(str_c("studydata/risk/chtc/", study,
                                 #"/train_glmnet_nested_1_x_10_3_x_10_v1_main/output"))
                                 "/train_xgboost_nested_1_x_10_3_x_10_v2_main/output"))
                                 #"/train_xgboost_nested_1_x_10_3_x_10_v3_main/output"))
                                 #"/train_xgboost_nested_1_x_10_3_x_10_v4_main/output"))
```
...
```{r}
results_all <- read_csv(here::here(path_output, "batch_results.csv"),
                        show_col_types = FALSE)
```

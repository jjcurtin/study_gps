...
<!--hard to monitor too;  lifelong.  needs/adjustments vary.  Unpack at bit in second paragraph?-->
<!--CP: drop the stats, focus more on cognitive burden of monitoring and how some things you might not have insight into-->
...
<!--I dont live driving factors.  inputs with sufficient precision; measuement can be sustained and scaled;  predicts well enough for clinical decision making; can be used for recommendations-->
<!--CP: what does a risk monitoring system actually need-->
...
<!-- is persona sensing anythning collected on phones or wearables?   By definition its embedded in real life, longitudinal.   Do you need active passive distinction here or aT all?   Not sure about the machine learnintg makes it scalable-->
...
<!--not sure that brief surveys are EMAs.   EMAs aRe a subset of those;  Can highlight burden and insight but remember, we only do it 1x daily now.  Can highlight length-->
...
<!--need to think a bit more about this sampling density.   Remember were arent doing JIT per se.  Just daily prediction.  So daily measurement may be sufficient;  I think insight and aLso what can you even remember and number of things are the bigger distinctions between EMA and gps-->
...
<!-- is this a big part of the paper?   I dont think we have a comparison, right-->
...
<!-- is explanatory goals the same as intervenable.  Not sure it is.  Example isnt that compelling-->
...
<!--not sure if you need to think much about public data.   Maybe?   But you can focus on things that aRe subjective or not generaL about locaTions-->
<!--CP: public data belongs in discussion-->

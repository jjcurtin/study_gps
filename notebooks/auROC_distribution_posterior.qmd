...
probs_chtc <- read_csv(here::here(path_models, str_c("best_config_",
                                             version, "_",
                                             cv, "_", model, ".csv"))) |> 
  glimpse()
```
...
probs_chtc |> 
  ...
  geom_histogram(bins = 10, fill = c("#af1f21")) +
  geom_vline(xintercept = median(probs_chtc$roc_auc), color = c("#f29c96"), lwd = 1, linetype="longdash") +
  labs(x = "auROC", y = "Frequency")
```

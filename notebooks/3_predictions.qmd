...
> CP: think we need to incorporate some code from here analysis_risk/ema/mak_scripts/2_metrics_outer_1day_0_v5_nested_main.html in order to get metrics from both RAW, iso, logistic, and beta calibrated probabilities. Right now it's not explicitly labeled as raw but I think that's all we're getting?

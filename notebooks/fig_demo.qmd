...
dem_data |> 
  ...
  geom_histogram(aes(y = after_stat(density)),
                 color = "#132157FF", fill = "white", bins = 15) +
  geom_density(color = "darkred", fill = "firebrick2", alpha = .3) +
  geom_vline(xintercept = median(dem_data$age), color = "#132157FF", lwd = .5, linetype="dashed") +
  xlab("Age") +
  ylab("Density") +
...
dem_data |> 
  ...
  geom_histogram(aes(y = after_stat(density)),
                 color = "#132157FF", fill = "white", bins = 15) +
  geom_density(color = "#EE6100FF", fill = "#FFAD0AFF", alpha = .3) +
  geom_vline(xintercept = median(dem_data$income), color = "#132157FF", lwd = .5, linetype="dashed") +
  xlab("Income") +
  ylab("Density") +
  scale_y_continuous(expand = c(0,0))
dev.off()
...
dem_data |>
  ...
  geom_histogram(aes(y = after_stat(density)),
                 color = "#132157FF", fill = "white", binwidth = 1) +
  geom_density(color = "#132157FF", fill = "#1BB6AFFF", alpha = .3) +
  geom_vline(xintercept = 9, color = "#132157FF", lwd = .5, linetype="dashed") +

...
> CP 6/12: what is the same/different between the study_dates and the visit_dates file? update vroom

```{r}
study_dates <- vroom::vroom(here::here(path_gps, "study_dates.csv"), col_types = "dTTT",
...
```{r}
locs <- vroom::vroom(here::here(path_shared, "locations.csv"), col_types = "cddcccccccccccdd",
              show_col_types = FALSE) |>  
...
> CP 6/12: when I run this it doesn't look like anything happens
...
```{r}
gps <-  vroom::vroom(here::here(path_shared, "gps.csv"), col_types = "ddTdccccdddd",
              show_col_types = FALSE)  |>  
...
> CP 6/12: same as above, not sure what this does
...
```{r}
## CP 6/12: I added parallel processing above -- does what I added do the same thing as below?

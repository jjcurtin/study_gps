...
plain-language-summary: |
  Geolocation data can predict next-day alcohol lapse with a fair level of performance. Time spent at risky locations, time spent across various types of places, and time spent at locations where alcohol is available were all important model features. These features could be integrated within a continuous risk monitoring system designed to provide temporally specific feedback about modifiable lapse risk behaviors. However, this model doe not currently perform the same across privileged and unprivileged subgroups.
#key-points:
  #- Take away point 1 
  #- Take away point 2
date: last-modified

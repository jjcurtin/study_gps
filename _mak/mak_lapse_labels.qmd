...
add this to make study dates script
...
if (params$roll_dur == "day"){
 ...
 #add ema_end to study_dates
 study_dates <- study_dates |> 
   left_join(lapses |> select(subid, ema_end), by = "subid") |> view()
...
```{r}
labels |> 
  write_csv(here(path_gps, str_c("labels_", params$roll_dur, ".csv"))) |> 
  glimpse()
```
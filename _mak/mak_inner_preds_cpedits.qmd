...
if(!file.exists(here::here(path_models, str_c("inner_shapsgrp_",
  ...
  shaps_out_grp <- shaps_out |> 
    ...
    mutate(variable_grp = if_else(str_detect(variable, ".risk"), "risky location", variable),
           # maybe this should be stratified by specific types of locations?
           ...
           # can remove this once we fix typo above !!!!
           variable_grp = if_else(str_detect(variable_grp, "var_location"), "location variance", variable_grp),

...
<!-- the above still seems like its interactions.  Lets discuss more -->
...
<!-- seems a little late for this given you have been discussing GPS for a bit now!  But not a big issue-->
...
<!--  also note that models may performance unfairly even if there is good group representation-->
...
<!-- this may lead these to work BETTER for this unprivledge groups.  Tie back to previous comment? --> 
...
<!-- not sure I understand the second sentence above -->

### Current study
<!-- you had three aims in the significance section! -->
